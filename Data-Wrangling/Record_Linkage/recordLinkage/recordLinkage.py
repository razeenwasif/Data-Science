...
#
#blocking_attrA_list = blocking.noBlocking(recA_dict)
#blocking_attrB_list = blocking.noBlocking(recB_dict)

# Simple attribute-based blocking
#
#blocking_attrA_list = blocking.simpleBlocking(recA_dict, blocking_attrA_list)
#blocking_attrB_list = blocking.simpleBlocking(recB_dict, blocking_attrB_list)

# Phonetic (Soundex) based blocking
#
#blocking_attrA_list = blocking.phoneticBlocking(recA_dict, blocking_attrA_list)
#blocking_attrB_list = blocking.phoneticBlocking(recB_dict, blocking_attrB_list)
...
#blocking_attrA_list = blocking.slkBlocking(recA_dict, fam_name_attr_ind, \
#                                   giv_name_attr_ind, dob_attr_ind, \
#                                   gender_attr_ind)
#blocking_attrB_list = blocking.slkBlocking(recB_dict, fam_name_attr_ind, \
#                                   giv_name_attr_ind, dob_attr_ind, \
#                                   gender_attr_ind)

canopy_attr_list = [1, 3]
canopy_distance_metric = lambda val1, val2: 1 - comparison.jaccard_comp(val1, val2)
T1 = 0.4 # Loose Threshold (distance)
T2 = 0.1 # Tight Threshold (distance)
blocking_attrA_list = blocking.canopy_clustering(recA_dict, canopy_attr_list,
                                                 canopy_distance_metric, T1, T2)
blocking_attrB_list = blocking.canopy_clustering(recB_dict, canopy_attr_list,
                                                 canopy_distance_metric, T1, T2)
...
#
blocking.printBlockStatistics(blocking_attrA_list, blocking_attrB_list)
...
sim_vec_dict = comparison.compareBlocks(blocking_attrA_list, blocking_attrB_list, \
                                        recA_dict, recB_dict, \
